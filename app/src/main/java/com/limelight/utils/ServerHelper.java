...
public class ServerHelper {
    ...
    public static Intent createStartIntent(Activity parent, NvApp app, ComputerDetails computer,
                                           ...
                                           boolean productivityMode, boolean productivityDepth) {
        Intent intent = new Intent(parent, Game.class);
        intent.putExtra(Game.EXTRA_PRODUCTIVITY_MODE, productivityMode);
        intent.putExtra(Game.EXTRA_PRODUCTIVITY_DEPTH, productivityDepth);
    ...
    public static void doStart(Activity parent, NvApp app, ComputerDetails computer,
        ...
        Intent intent = createStartIntent(parent, app, computer, managerBinder, productivityMode, productivityDepth);
